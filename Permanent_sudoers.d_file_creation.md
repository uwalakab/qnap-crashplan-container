...
SSH into your NAS as admin and mount the special configuration partition where autorun.sh resides. The exact command varies by model, but for Intel-based units like the TS-253, it is typically:
```
bash
